...
struct jit_uni_tbb_batch_normalization_fwd_t: public cpu_primitive_t {
    struct pd_t: public cpu_batch_normalization_fwd_pd_t {
        ...
        DECLARE_COMMON_PD_T(
                JIT_IMPL_NAME_HELPER("tbb_jit:", isa, ""),
...
template <cpu_isa_t isa>
struct jit_uni_tbb_batch_normalization_bwd_t: public cpu_primitive_t {
