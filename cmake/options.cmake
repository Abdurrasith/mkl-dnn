...
set(DNNL_TEST_THREADPOOL_IMPL "STANDALONE" CACHE STRING
    ...
    TBB")
if(NOT "${DNNL_TEST_THREADPOOL_IMPL}" MATCHES "^(STANDALONE|TBB|EIGEN)$")
    message(FATAL_ERROR
        "Unsupported threadpool implementation: ${DNNL_TEST_THREADPOOL_IMPL}")
endif()
