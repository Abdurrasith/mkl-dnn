...
if("${DNNL_CPU_THREADING_RUNTIME}" STREQUAL "THREADPOOL")
    ...
    if("${DNNL_TEST_THREADPOOL_IMPL}" STREQUAL "TBB")
        find_package_tbb(REQUIRED)
        if(TBB_FOUND)
            list(APPEND EXTRA_STATIC_LIBS TBB::tbb)
            message(STATUS "Threadpool testing: TBB (${_tbb_root})")
            set(DNNL_TEST_THREADPOOL_IMPL "TBB")
        endif()
    endif()

    if("${DNNL_TEST_THREADPOOL_IMPL}" STREQUAL "EIGEN")
    ...
    if("${DNNL_TEST_THREADPOOL_IMPL}" STREQUAL "STANDALONE")
        message(STATUS "Threadpool testing: standalone")
    endif()

    add_definitions(-DDNNL_TEST_THREADPOOL_USE_${DNNL_TEST_THREADPOOL_IMPL})
endif()
